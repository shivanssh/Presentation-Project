  ...
  return (
    ...
    >
      ...
      <Paper sx={{ width: "95%", height: 250, p: 1, paddingBottom: 3 }}>
        <Stack direction="column" spacing={1}>
          <Stack direction="row" spacing={2} padding={1}>
            <Typography variant="h6">Account 2 : </Typography>
...
export const getTargetDesign = (target, q1, q2, q3, q4, q5) => {
  return (
...
export default function BasicDetailPanelsTrueGlobal() {
